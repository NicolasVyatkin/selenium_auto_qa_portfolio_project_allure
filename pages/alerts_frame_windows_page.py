...
import random
import allure
from locators.alerts_frame_windows_locators import AlertsPageLocators, BrowserWindowPageLocators, IframePageLocators, ModalDialogsPageLocators, NestedFramesPageLocators
...
class AlertsPage(BasePage):
    ...
    def check_alert_appear_5_sec(self):
        self.element_is_visible(
            self.locators.APPEAR_ALERT_AFTER_FIVE_SEC_BUTTON).click()
        time.sleep(6)
        try:
            alert_window = self.driver.switch_to.alert
            return alert_window.text
